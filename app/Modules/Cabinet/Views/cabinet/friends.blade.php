...
@section('content')
    ...
    <h2>Друзья пользователя {{ $user->login }}</h2>
    ...
    <div class="blog with-filters">
        <div class="filters">
            <div class="on-page">
                Всего<span class="hidden-xs"> друзей</span>:
        ...
        <div class="list users-list p-t-0">
            <div class="item user online">
                ...
                <div class="user">
                    ...
                    <span class="fullname">Иван Плахотин</span>
                    <span class="rank">Эксперт</span>
                    <span class="date">
                                                    <span>В друзьях:</span>
                                                    <span class="value">1 год 3 месяца 22 дня</span>
                                                </span>
                </div>
                <div class="buttons">
