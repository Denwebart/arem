...
<head>
    <meta charset="utf-8" />
    <title>OZVUCHKA.com - Административная панель</title>
...
<script type="text/javascript">
    ...
    var dropifyOptions = {
        ...
        error: {
            'fileSize': "Размер файла слишком большой (максимум @{{ value }}Мб).",
            'minWidth': "Ширина изображения не может быть меньше, чем @{{ value }}px.",
            'maxWidth': "Ширина изображения не может быть больше, чем @{{ value }}px.",
            'minHeight': "Высота изображения не может быть меньше, чем @{{ value }}px.",
            'maxHeight': "Высота изображения не может быть больше, чем @{{ value }}px.",
            'imageFormat': "Формат изображения не поддерживается (только @{{ value }})."
        }
    };
</script>
