    ...
    <div class="col-lg-6 col-sm-12 col-xs-12 m-b-15">
        ...
        {{--<div class="form-group">--}}
            {{--<div class="col-sm-10 col-sm-offset-2">--}}
                ...
                {{--<span class="m-l-10 text-muted help-popover" data-container="body" title="" data-toggle="popover" data-trigger="hover" data-placement="right" tabindex="0" data-content="Страница будет опубликована на сайте не сразу, а в заданное время." data-original-title="Отложенная публикация">--}}
                    {{--<i class="fa fa-question-circle-o"></i>--}}
                {{--</span>--}}
            {{--</div>--}}
